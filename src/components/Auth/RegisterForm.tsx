    ...
    <>
      <style>
        {`
          ...
          .register-field-3d .MuiOutlinedInput-root {
          ...
          .register-field-3d .MuiOutlinedInput-root .MuiOutlinedInput-notchedOutline {
            border: 2px solid rgba(255, 107, 53, 0.3) !important;
            transition: all 0.3s ease !important;
          }
          
          .register-field-3d .MuiOutlinedInput-root:hover .MuiOutlinedInput-notchedOutline {
            border-color: rgba(255, 107, 53, 0.6) !important;
            box-shadow: 0 0 20px rgba(255, 107, 53, 0.2) !important;
          }
          
          .register-field-3d .MuiOutlinedInput-root.Mui-focused .MuiOutlinedInput-notchedOutline {
            border-color: #ff6b35 !important;
            border-width: 2px !important;
            box-shadow: 0 0 25px rgba(255, 107, 53, 0.4) !important;
          }
          
          .register-field-3d .MuiInputLabel-root {
            color: rgba(255, 255, 255, 0.7) !important;
            font-family: 'Rubik', sans-serif !important;
            font-weight: 500 !important;
          }
          
          .register-field-3d .MuiInputLabel-root.Mui-focused {
            color: #ff6b35 !important;
          }
          
          .register-field-3d input {
            color: #ffffff !important;
            font-family: 'Rubik', sans-serif !important;
          ...
          .register-button-3d:hover::before {
            left: 100%;
          }
      ...
      <div className="register-universe">
        <Container maxWidth="sm">
          <Paper elevation={3} className="register-paper-3d">
            <div className="register-content-3d">
              <Typography variant="h4" component="h1" className="register-title-3d">
                📝 הרשמה
              </Typography>
              ...
              {success && (
                ...
                >
                  נרשמת בהצלחה! מעביר אותך לעמוד הבית...
                </Alert>
              )}
              ...
              <Box component="form" onSubmit={handleSubmit(onSubmit)} sx={{ mt: 2 }}>
                ...
                <Button type="submit" fullWidth variant="contained" className="register-button-3d" disabled={loading}>
                  {loading ? <CircularProgress size={24} sx={{ color: "white" }} /> : "הירשם"}
                </Button>
                ...
                <Box textAlign="center" sx={{ mt: 4, position: "relative", zIndex: 2 }}>
                  ...
                  >
                    כבר יש לך חשבון?{" "}
                    <Link to="/login" className="register-link-3d">
                      התחבר כאן
                    </Link>
                  </Typography>
                </Box>
